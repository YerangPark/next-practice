...
const MainPage: React.FC = () => {
  ...
  return (
    <div>
      ...
      <LoginModal isOpen={isLoginModalOpen} onClose={closeLoginModal} openSignupModal={openSignupModal} openFindIdModal={openFindIdModal} openFindPasswordModal={openFindPasswordModal} />
      <FindIdModal isOpen={isFindIdModalOpen} onClose={closeFindIdModal} openLoginModal={openLoginModal} />
      <FindPasswordModal isOpen={isFindPasswordModalOpen} onClose={closeFindPasswordModal} openLoginModal={openLoginModal} />
    </div>
  );
};
